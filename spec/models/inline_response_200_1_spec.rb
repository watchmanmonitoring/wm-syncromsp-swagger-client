...
# Unit tests for WmSyncromspSwaggerClient::InlineResponse2001
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2001' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::InlineResponse2001.new
  end
  ...
  describe 'test an instance of InlineResponse2001' do
    it 'should create an instance of InlineResponse2001' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::InlineResponse2001)
    end
  end
  ...
  describe 'test attribute "longitud"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
