...
# Unit tests for WmSyncromspSwaggerClient::Body43
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body43' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body43.new
  end
  ...
  describe 'test an instance of Body43' do
    it 'should create an instance of Body43' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body43)
    end
  end
