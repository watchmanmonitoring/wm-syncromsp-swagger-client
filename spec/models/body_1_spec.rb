...
# Unit tests for WmSyncromspSwaggerClient::Body1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body1' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body1.new
  end
  ...
  describe 'test an instance of Body1' do
    it 'should create an instance of Body1' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body1)
    end
  end
