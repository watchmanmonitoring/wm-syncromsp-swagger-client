...
# Unit tests for WmSyncromspSwaggerClient::Body27
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body27' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body27.new
  end
  ...
  describe 'test an instance of Body27' do
    it 'should create an instance of Body27' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body27)
    end
  end
  ...
  describe 'test attribute "other_cents"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "delivery_tracking"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
