...
# Unit tests for WmSyncromspSwaggerClient::Body16
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body16' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body16.new
  end
  ...
  describe 'test an instance of Body16' do
    it 'should create an instance of Body16' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body16)
    end
  end
  ...
  describe 'test attribute "ticket_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
