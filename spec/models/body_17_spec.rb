...
# Unit tests for WmSyncromspSwaggerClient::Body17
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body17' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body17.new
  end
  ...
  describe 'test an instance of Body17' do
    it 'should create an instance of Body17' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body17)
    end
  end
