...
# Unit tests for WmSyncromspSwaggerClient::Body29
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body29' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body29.new
  end
  ...
  describe 'test an instance of Body29' do
    it 'should create an instance of Body29' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body29)
    end
  end
