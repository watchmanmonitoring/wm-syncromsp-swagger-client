...
# Unit tests for WmSyncromspSwaggerClient::Body5
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body5' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body5.new
  end
  ...
  describe 'test an instance of Body5' do
    it 'should create an instance of Body5' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body5)
    end
  end
  ...
  describe 'test attribute "asset_serial"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
