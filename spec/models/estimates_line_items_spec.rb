...
# Unit tests for WmSyncromspSwaggerClient::EstimatesLineItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EstimatesLineItems' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::EstimatesLineItems.new
  end
  ...
  describe 'test an instance of EstimatesLineItems' do
    it 'should create an instance of EstimatesLineItems' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::EstimatesLineItems)
    end
  end
