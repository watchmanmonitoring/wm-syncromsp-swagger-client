...
# Unit tests for WmSyncromspSwaggerClient::Body7
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body7' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body7.new
  end
  ...
  describe 'test an instance of Body7' do
    it 'should create an instance of Body7' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body7)
    end
  end
