...
# Unit tests for WmSyncromspSwaggerClient::Body21
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body21' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body21.new
  end
  ...
  describe 'test an instance of Body21' do
    it 'should create an instance of Body21' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body21)
    end
  end
