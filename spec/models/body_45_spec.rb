...
# Unit tests for WmSyncromspSwaggerClient::Body45
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body45' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body45.new
  end
  ...
  describe 'test an instance of Body45' do
    it 'should create an instance of Body45' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body45)
    end
  end
  describe 'test attribute "worksheet_template_id"' do
    it 'should work' do
