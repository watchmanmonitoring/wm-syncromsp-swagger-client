...
# Unit tests for WmSyncromspSwaggerClient::Body8
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body8' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body8.new
  end
  ...
  describe 'test an instance of Body8' do
    it 'should create an instance of Body8' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body8)
    end
  end
