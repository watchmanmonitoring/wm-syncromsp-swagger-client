...
# Unit tests for WmSyncromspSwaggerClient::Body28
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body28' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body28.new
  end
  ...
  describe 'test an instance of Body28' do
    it 'should create an instance of Body28' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body28)
    end
  end
