...
# Unit tests for WmSyncromspSwaggerClient::Body4
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body4' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body4.new
  end
  ...
  describe 'test an instance of Body4' do
    it 'should create an instance of Body4' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body4)
    end
  end
