...
# Unit tests for WmSyncromspSwaggerClient::Body36
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body36' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body36.new
  end
  ...
  describe 'test an instance of Body36' do
    it 'should create an instance of Body36' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body36)
    end
  end
