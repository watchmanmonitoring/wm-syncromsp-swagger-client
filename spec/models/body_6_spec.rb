...
# Unit tests for WmSyncromspSwaggerClient::Body6
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body6' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body6.new
  end
  ...
  describe 'test an instance of Body6' do
    it 'should create an instance of Body6' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body6)
    end
  end
