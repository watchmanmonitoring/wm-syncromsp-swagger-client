...
# Unit tests for WmSyncromspSwaggerClient::Body39
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body39' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body39.new
  end
  ...
  describe 'test an instance of Body39' do
    it 'should create an instance of Body39' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body39)
    end
  end
  ...
  describe 'test attribute "registration_token_gcm"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "screen_size"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
