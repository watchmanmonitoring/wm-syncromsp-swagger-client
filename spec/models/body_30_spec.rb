...
# Unit tests for WmSyncromspSwaggerClient::Body30
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body30' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body30.new
  end
  ...
  describe 'test an instance of Body30' do
    it 'should create an instance of Body30' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body30)
    end
  end
