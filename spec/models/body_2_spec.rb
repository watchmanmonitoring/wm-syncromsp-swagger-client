...
# Unit tests for WmSyncromspSwaggerClient::Body2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body2' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body2.new
  end
  ...
  describe 'test an instance of Body2' do
    it 'should create an instance of Body2' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body2)
    end
  end
