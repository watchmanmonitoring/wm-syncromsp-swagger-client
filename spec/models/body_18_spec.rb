...
# Unit tests for WmSyncromspSwaggerClient::Body18
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body18' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body18.new
  end
  ...
  describe 'test an instance of Body18' do
    it 'should create an instance of Body18' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body18)
    end
  end
