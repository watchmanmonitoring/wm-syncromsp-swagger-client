...
# Unit tests for WmSyncromspSwaggerClient::Body12
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body12' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body12.new
  end
  ...
  describe 'test an instance of Body12' do
    it 'should create an instance of Body12' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body12)
    end
  end
