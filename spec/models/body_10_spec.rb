...
# Unit tests for WmSyncromspSwaggerClient::Body10
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body10' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body10.new
  end
  ...
  describe 'test an instance of Body10' do
    it 'should create an instance of Body10' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body10)
    end
  end
