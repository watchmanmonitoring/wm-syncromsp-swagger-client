...
# Unit tests for WmSyncromspSwaggerClient::Body20
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body20' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body20.new
  end
  ...
  describe 'test an instance of Body20' do
    it 'should create an instance of Body20' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body20)
    end
  end
