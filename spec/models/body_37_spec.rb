...
# Unit tests for WmSyncromspSwaggerClient::Body37
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body37' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body37.new
  end
  ...
  describe 'test an instance of Body37' do
    it 'should create an instance of Body37' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body37)
    end
  end
  describe 'test attribute "timer_entry_id"' do
    it 'should work' do
