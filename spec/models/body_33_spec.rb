...
# Unit tests for WmSyncromspSwaggerClient::Body33
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body33' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body33.new
  end
  ...
  describe 'test an instance of Body33' do
    it 'should create an instance of Body33' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body33)
    end
  end
