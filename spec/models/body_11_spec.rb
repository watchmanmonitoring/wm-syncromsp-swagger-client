...
# Unit tests for WmSyncromspSwaggerClient::Body11
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body11' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body11.new
  end
  ...
  describe 'test an instance of Body11' do
    it 'should create an instance of Body11' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body11)
    end
  end
