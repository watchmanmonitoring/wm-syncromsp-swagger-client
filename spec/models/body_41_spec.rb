...
# Unit tests for WmSyncromspSwaggerClient::Body41
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body41' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body41.new
  end
  ...
  describe 'test an instance of Body41' do
    it 'should create an instance of Body41' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body41)
    end
  end
