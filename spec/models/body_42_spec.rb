...
# Unit tests for WmSyncromspSwaggerClient::Body42
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body42' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body42.new
  end
  ...
  describe 'test an instance of Body42' do
    it 'should create an instance of Body42' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body42)
    end
  end
