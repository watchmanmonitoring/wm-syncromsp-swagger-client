...
# Unit tests for WmSyncromspSwaggerClient::Body3
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Body3' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::Body3.new
  end
  ...
  describe 'test an instance of Body3' do
    it 'should create an instance of Body3' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::Body3)
    end
  end
  ...
  describe 'test attribute "email_customer"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "appointment_duration"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
