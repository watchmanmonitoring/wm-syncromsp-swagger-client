...
# Unit tests for WmSyncromspSwaggerClient::SettingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SettingApi' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::SettingApi.new
  end
  ...
  describe 'test an instance of SettingApi' do
    it 'should create an instance of SettingApi' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::SettingApi)
    end
  end
  ...
  # unit tests for settings_printing_get
  # Returns Printing Settings
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'settings_printing_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for settings_tabs_get
  # Returns Tabs Settings
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'settings_tabs_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
