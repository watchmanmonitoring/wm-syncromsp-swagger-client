...
# Unit tests for WmSyncromspSwaggerClient::CallApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallApi' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::CallApi.new
  end
  ...
  describe 'test an instance of CallApi' do
    it 'should create an instance of CallApi' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::CallApi)
    end
  end

  # unit tests for callerid_get
  # Get Caller ID
  # @param did Phone number
  # @param [Hash] opts the optional parameters
  # @option opts [BOOLEAN] :outbound 
  # @return [nil]
  describe 'callerid_get test' do
    it 'should work' do
