...
# Unit tests for WmSyncromspSwaggerClient::ItemApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemApi' do
  before do
    # run before each test
    @instance = WmSyncromspSwaggerClient::ItemApi.new
  end
  ...
  describe 'test an instance of ItemApi' do
    it 'should create an instance of ItemApi' do
      expect(@instance).to be_instance_of(WmSyncromspSwaggerClient::ItemApi)
    end
  end
