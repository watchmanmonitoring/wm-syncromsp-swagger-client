...
module WmSyncromspSwaggerClient
  class Body39
    ...
    attr_accessor :registration_token_gcm
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WmSyncromspSwaggerClient::Body39` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WmSyncromspSwaggerClient::Body39`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'registration_token_gcm')
        self.registration_token_gcm = attributes[:'registration_token_gcm']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          registration_token_gcm == o.registration_token_gcm &&
    ...
    def hash
      [device_uuid, device_name, registration_token_gcm, system_name, model, screen_size].hash
    end
